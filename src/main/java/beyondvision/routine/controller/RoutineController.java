...
public class RoutineController {
    ...
    @ResponseBody
    @PostMapping(value = "/routine/register/{memberId}")
    ...
    @GetMapping(value ="/routine/detail/{memberId}")
    ...
    @PutMapping(value ="/routine/modify/{memberId}/{routineId}")
    ...
    @DeleteMapping(value ="/routine/delete/{memberId}/{routineId}")
